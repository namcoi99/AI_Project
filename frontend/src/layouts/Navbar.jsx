...
const Navbar = () => {
    return (
        <header className="px-3 py-2 bg-white text-dark" style={{ borderBottom: "1px solid lightgrey" }}>
            <div className="container-xxl">
                <div className="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                    <NavLink to="/" exact={true} className="d-flex align-items-center my-2 my-lg-0 me-lg-auto text-dark text-decoration-none" style={{ fontSize: "25px", fontFamily: "Lucida Handwriting" }}>
                        Websites Evaluator
                    </NavLink>
